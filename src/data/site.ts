...
export interface Title {
  ...
  subject: 'maths' | 'english' | 'french' | 'science' | 'social';
  lang: 'en' | 'fr';
  cover: string;
  en: { title: string; note: string };
  fr: { title: string; note: string };
}

/** SAMPLE DATA — replaced by Netlify Database (open item 4, Docs/README.md). */
export const TITLES: Title[] = [
  { id: 't1', level: 'primary',   subject: 'maths',   lang: 'en', cover: 'Mathematics|Primary 5',
    en: { title: 'Mathematics — Primary 5', note: 'Cameroon national curriculum.' },
    fr: { title: 'Mathematics — Primary 5', note: 'Programme national — Cameroun.' } },
  { id: 't2', level: 'primary',   subject: 'maths',   lang: 'fr', cover: 'Mathématiques|CM1',
    en: { title: 'Mathématiques — CM1', note: 'Cameroon national curriculum.' },
    fr: { title: 'Mathématiques — CM1', note: 'Programme national — Cameroun.' } },
  { id: 't3', level: 'primary',   subject: 'science', lang: 'en', cover: 'Integrated|Science',
    en: { title: 'Integrated Science — Primary 4', note: 'Cameroon national curriculum.' },
    fr: { title: 'Integrated Science — Primary 4', note: 'Programme national — Cameroun.' } },
  { id: 't4', level: 'primary',   subject: 'social',  lang: 'fr', cover: 'Éducation|Civique',
    en: { title: 'Éducation Civique — CE2', note: 'DRC national curriculum.' },
    fr: { title: 'Éducation Civique — CE2', note: 'Programme national — RDC.' } },
  { id: 't5', level: 'secondary', subject: 'english', lang: 'en', cover: 'English|Language',
    en: { title: 'English Language — Form 3', note: 'Cameroon national curriculum.' },
    fr: { title: 'English Language — Form 3', note: 'Programme national — Cameroun.' } },
  { id: 't6', level: 'secondary', subject: 'french',  lang: 'fr', cover: 'Français|6ᵉ',
    en: { title: 'Français — Classe de 6ᵉ', note: 'Cameroon national curriculum.' },
    fr: { title: 'Français — Classe de 6ᵉ', note: 'Programme national — Cameroun.' } },
  { id: 't7', level: 'secondary', subject: 'maths',   lang: 'en', cover: 'Mathematics|Form 4',
    en: { title: 'Mathematics — Form 4', note: 'Cameroon national curriculum.' },
    fr: { title: 'Mathematics — Form 4', note: 'Programme national — Cameroun.' } },
  { id: 't8', level: 'secondary', subject: 'science', lang: 'fr', cover: 'Sciences|de la Vie',
    en: { title: 'Sciences de la Vie — 5ᵉ', note: 'DRC national curriculum.' },
...
/** PLACEHOLDER — News scope is open item 5 (Docs/README.md). */
export const ARTICLES: Article[] = [
  { id: 'n1', category: 'company',      icon: 'news',  en: { title: 'Placeholder: a company announcement' },     fr: { title: 'Exemple : une annonce de l’entreprise' } },
  { id: 'n2', category: 'titles',       icon: 'book',  en: { title: 'Placeholder: a new title release' },        fr: { title: 'Exemple : la parution d’un nouveau titre' } },
  { id: 'n3', category: 'partnerships', icon: 'users', en: { title: 'Placeholder: a partnership announcement' }, fr: { title: 'Exemple : l’annonce d’un partenariat' } },
  { id: 'n4', category: 'events',       icon: 'cal',   en: { title: 'Placeholder: an event or book fair' },      fr: { title: 'Exemple : un événement ou un salon du livre' } },
  { id: 'n5', category: 'company',      icon: 'pen',   en: { title: 'Placeholder: a team or capacity update' },  fr: { title: 'Exemple : une actualité sur l’équipe' } },
  { id: 'n6', category: 'titles',       icon: 'print', en: { title: 'Placeholder: a bilingual edition release' },fr: { title: 'Exemple : la parution d’une édition bilingue' } },
];
