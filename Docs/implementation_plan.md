...
| 2026-09-11 | Completed the next unblocked CMS slice locally: protected Catalogue and News APIs now support list, create, edit, delete, draft, and publish workflows; their admin screens provide bilingual editors and status-aware lists. No launch content was fabricated. Astro build and standalone function bundling pass; unauthenticated admin API access returns HTTP 401. |
| 2026-09-11 | Rebuilt the core admin UI locally: branded responsive login, persistent content-workspace navigation, elevated dashboard, workflow guidance, and redesigned Catalogue/News editor surfaces. The implementation emphasizes bilingual draft/publish workflow states, accessible focus treatment, and small-screen navigation. Local production build passes; awaiting visual review and release authorization. |
